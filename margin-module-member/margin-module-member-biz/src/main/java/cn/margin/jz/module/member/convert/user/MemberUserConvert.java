package cn.margin.jz.module.member.convert.user;

import cn.margin.jz.framework.common.pojo.PageResult;
import cn.margin.jz.module.member.api.user.dto.MemberUserRespDTO;
import cn.margin.jz.module.member.controller.admin.user.vo.MemberUserRespVO;
import cn.margin.jz.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import cn.margin.jz.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;
import cn.margin.jz.module.member.convert.address.AddressConvert;
