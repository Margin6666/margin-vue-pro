package cn.margin.jz.module.member.controller.admin.config;

import cn.margin.jz.framework.common.pojo.CommonResult;
import cn.margin.jz.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.margin.jz.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.margin.jz.module.member.convert.config.MemberConfigConvert;
import cn.margin.jz.module.member.dal.dataobject.config.MemberConfigDO;
import cn.margin.jz.module.member.service.config.MemberConfigService;
