package cn.margin.jz.module.member.service.level;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.NumberUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.margin.jz.module.member.controller.admin.level.vo.level.MemberLevelCreateReqVO;
import cn.margin.jz.module.member.controller.admin.level.vo.level.MemberLevelListReqVO;
import cn.margin.jz.module.member.controller.admin.level.vo.level.MemberLevelUpdateReqVO;
import cn.margin.jz.module.member.controller.admin.user.vo.MemberUserUpdateLevelReqVO;
import cn.margin.jz.module.member.convert.level.MemberLevelConvert;
import cn.margin.jz.module.member.convert.level.MemberLevelRecordConvert;
import cn.margin.jz.module.member.dal.dataobject.level.MemberLevelDO;
import cn.margin.jz.module.member.dal.dataobject.level.MemberLevelRecordDO;
import cn.margin.jz.module.member.dal.dataobject.user.MemberUserDO;
import cn.margin.jz.module.member.dal.mysql.level.MemberLevelMapper;
import cn.margin.jz.module.member.enums.MemberExperienceBizTypeEnum;
