...
import cn.margin.jz.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import cn.margin.jz.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, MarginRedisAutoConfiguration.class})
