package cn.margin.jz.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import cn.margin.jz.framework.common.pojo.PageResult;
import cn.margin.jz.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import cn.margin.jz.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.margin.jz.module.mp.convert.message.MpMessageConvert;
import cn.margin.jz.module.mp.dal.dataobject.account.MpAccountDO;
import cn.margin.jz.module.mp.dal.dataobject.message.MpMessageDO;
import cn.margin.jz.module.mp.dal.dataobject.user.MpUserDO;
import cn.margin.jz.module.mp.dal.mysql.message.MpMessageMapper;
import cn.margin.jz.module.mp.enums.message.MpMessageSendFromEnum;
import cn.margin.jz.module.mp.framework.mp.core.MpServiceFactory;
import cn.margin.jz.module.mp.framework.mp.core.util.MpUtils;
import cn.margin.jz.module.mp.service.account.MpAccountService;
import cn.margin.jz.module.mp.service.material.MpMaterialService;
import cn.margin.jz.module.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.margin.jz.module.mp.service.user.MpUserService;
...
import static cn.margin.jz.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
