...
import cn.margin.jz.framework.sms.config.MarginSmsAutoConfiguration;
import cn.margin.jz.module.system.test.BaseDbAndRedisIntegrationTest;
...
// TODO @芋艿：需要迁移
@Import({MarginSmsAutoConfiguration.class,
