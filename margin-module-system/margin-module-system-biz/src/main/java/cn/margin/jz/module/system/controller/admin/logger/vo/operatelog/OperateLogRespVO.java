package cn.margin.jz.module.system.controller.admin.logger.vo.operatelog;
...
import cn.margin.jz.module.system.enums.DictTypeConstants;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "cn.margin.jz.adminserver.UserController.save(...)")
