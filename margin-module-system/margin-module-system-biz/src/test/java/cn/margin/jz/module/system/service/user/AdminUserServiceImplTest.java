package cn.margin.jz.module.system.service.user;
...
import cn.margin.jz.framework.common.util.collection.ArrayUtils;
...
import cn.margin.jz.module.infra.api.file.FileApi;
import cn.margin.jz.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.margin.jz.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.margin.jz.module.system.controller.admin.user.vo.user.*;
import cn.margin.jz.module.system.dal.dataobject.dept.DeptDO;
import cn.margin.jz.module.system.dal.dataobject.dept.PostDO;
import cn.margin.jz.module.system.dal.dataobject.dept.UserPostDO;
import cn.margin.jz.module.system.dal.dataobject.tenant.TenantDO;
import cn.margin.jz.module.system.dal.dataobject.user.AdminUserDO;
import cn.margin.jz.module.system.dal.mysql.dept.UserPostMapper;
import cn.margin.jz.module.system.dal.mysql.user.AdminUserMapper;
import cn.margin.jz.module.system.enums.common.SexEnum;
import cn.margin.jz.module.system.service.dept.DeptService;
import cn.margin.jz.module.system.service.dept.PostService;
import cn.margin.jz.module.system.service.permission.PermissionService;
import cn.margin.jz.module.system.service.tenant.TenantService;
...
import static cn.margin.jz.framework.common.util.collection.SetUtils.asSet;
import static cn.margin.jz.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.margin.jz.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.margin.jz.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.margin.jz.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.margin.jz.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.margin.jz.framework.test.core.util.RandomUtils.*;
import static cn.margin.jz.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("marginyuanma");
        ...
        assertEquals("marginyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("marginyuanma"))).thenReturn("java");
