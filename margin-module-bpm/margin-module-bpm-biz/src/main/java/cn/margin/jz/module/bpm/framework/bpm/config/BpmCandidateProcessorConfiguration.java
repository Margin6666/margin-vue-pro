package cn.margin.jz.module.bpm.framework.bpm.config;

import cn.margin.jz.module.bpm.framework.flowable.core.behavior.script.BpmTaskAssignScript;
import cn.margin.jz.module.bpm.service.candidate.sourceInfoProcessor.*;
import org.springframework.beans.factory.ObjectProvider;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

// TODO @芋艿：Candidate 相关还在完善中，用户可以暂时忽略，仅 margin 开发的同学需要关注~计划是把 Candidate 和 Assign 融合成一套
/**
