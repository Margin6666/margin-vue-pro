...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.margin.boot";
    private static final String ARTIFACT_ID = "margin";
    private static final String PACKAGE_NAME = "cn.margin.jz";
    private static final String TITLE = "峡谷先崩";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.margin.boot";
        String artifactIdNew = "margin";
        String packageNameNew = "cn.margin.jz";
        String titleNew = "峡谷先崩";
