package cn.margin.jz.module.infra.service.codegen.inner;
...
import cn.margin.jz.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.margin.jz.framework.excel.core.annotations.DictFormat;
import cn.margin.jz.framework.excel.core.convert.DictConvert;
import cn.margin.jz.framework.excel.core.util.ExcelUtils;
import cn.margin.jz.framework.mybatis.core.dataobject.BaseDO;
...
import cn.margin.jz.framework.operatelog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "margin-module-${table.moduleName}/" + // 顶级模块
                "margin-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "margin-module-${table.moduleName}/" + // 顶级模块
                "margin-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "margin-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "margin-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
