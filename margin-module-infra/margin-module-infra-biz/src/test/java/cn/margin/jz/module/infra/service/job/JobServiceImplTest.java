package cn.margin.jz.module.infra.service.job;

import cn.margin.jz.framework.common.pojo.PageResult;
import cn.margin.jz.framework.quartz.core.scheduler.SchedulerManager;
import cn.margin.jz.framework.test.core.ut.BaseDbUnitTest;
import cn.margin.jz.module.infra.controller.admin.job.vo.job.JobPageReqVO;
import cn.margin.jz.module.infra.controller.admin.job.vo.job.JobSaveReqVO;
import cn.margin.jz.module.infra.dal.dataobject.job.JobDO;
import cn.margin.jz.module.infra.dal.mysql.job.JobMapper;
import cn.margin.jz.module.infra.enums.job.JobStatusEnum;
