package cn.margin.jz.module.infra.service.logger;
...
import cn.margin.jz.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import cn.margin.jz.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.margin.jz.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.margin.jz.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.margin.jz.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.margin.jz.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.margin.jz.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("margin-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("margin-test");
