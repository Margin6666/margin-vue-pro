package cn.margin.jz.framework.tracer.config;

import cn.margin.jz.framework.common.enums.WebFilterOrderEnum;
import cn.margin.jz.framework.tracer.core.aop.BizTraceAspect;
import cn.margin.jz.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "margin.tracer", value = "enable", matchIfMissing = true)
public class MarginTracerAutoConfiguration {
