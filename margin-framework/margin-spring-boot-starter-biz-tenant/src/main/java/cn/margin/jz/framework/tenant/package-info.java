 ...
 *      1）Spring Async：
 *          {@link cn.margin.jz.framework.quartz.config.MarginAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 MarginSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.margin.jz.framework.tenant;
