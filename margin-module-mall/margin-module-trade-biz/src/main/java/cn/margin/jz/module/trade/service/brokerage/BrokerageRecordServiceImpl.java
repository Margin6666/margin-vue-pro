package cn.margin.jz.module.trade.service.brokerage;
...
import cn.margin.jz.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import cn.margin.jz.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import cn.margin.jz.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
import cn.margin.jz.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankPageReqVO;
import cn.margin.jz.module.trade.convert.brokerage.BrokerageRecordConvert;
import cn.margin.jz.module.trade.dal.dataobject.brokerage.BrokerageRecordDO;
import cn.margin.jz.module.trade.dal.dataobject.brokerage.BrokerageUserDO;
import cn.margin.jz.module.trade.dal.dataobject.config.TradeConfigDO;
import cn.margin.jz.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
import cn.margin.jz.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import cn.margin.jz.module.trade.enums.brokerage.BrokerageRecordStatusEnum;
import cn.margin.jz.module.trade.service.brokerage.bo.BrokerageAddReqBO;
import cn.margin.jz.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
import cn.margin.jz.module.trade.service.config.TradeConfigService;
...
import static cn.margin.jz.framework.common.util.collection.CollectionUtils.getMaxValue;
import static cn.margin.jz.framework.common.util.collection.CollectionUtils.getMinValue;
import static cn.margin.jz.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static cn.margin.jz.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
