package cn.margin.jz.module.promotion.service.banner;

import cn.margin.jz.framework.common.pojo.PageResult;
import cn.margin.jz.module.promotion.controller.admin.banner.vo.BannerCreateReqVO;
import cn.margin.jz.module.promotion.controller.admin.banner.vo.BannerPageReqVO;
import cn.margin.jz.module.promotion.controller.admin.banner.vo.BannerUpdateReqVO;
import cn.margin.jz.module.promotion.convert.banner.BannerConvert;
import cn.margin.jz.module.promotion.dal.dataobject.banner.BannerDO;
import cn.margin.jz.module.promotion.dal.mysql.banner.BannerMapper;
...
import static cn.margin.jz.module.promotion.enums.ErrorCodeConstants.BANNER_NOT_EXISTS;
